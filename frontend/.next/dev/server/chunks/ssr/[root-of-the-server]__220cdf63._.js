...
"[project]/hype_workspace/life_comrades/frontend/src/app/(pages)/services/layout.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/hype_workspace/life_comrades/frontend/src/app/(pages)/services/layout.tsx [app-rsc] (ecmascript)"));
}),
...
async function generateMetadata({ params }) {
    ...
    const { services: servicesArray } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hype_workspace$2f$life_comrades$2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getISRData"])();
    const services = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hype_workspace$2f$life_comrades$2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getServicesMap"])(servicesArray);
...
async function generateStaticParams() {
    const { services: servicesArray } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hype_workspace$2f$life_comrades$2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getISRData"])();
    return servicesArray.filter((s)=>s && typeof s.id === 'string' && s.id.trim() !== '').map((s)=>({
            id: s.id
        }));
}
async function ServiceDetailPage({ params }) {
    const { id } = await params;
    const { services: servicesArray } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hype_workspace$2f$life_comrades$2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getISRData"])();
    const servicesMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hype_workspace$2f$life_comrades$2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getServicesMap"])(servicesArray);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__220cdf63._.js.map